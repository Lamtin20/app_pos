...
export const rpcMap = {
  ...
  redeemMemberSunProgram: handlers.redeemMemberSunProgram,
  ...
  adminListMembershipPackages: handlers.adminListMembershipPackages,
  adminDeleteMembershipPackage: handlers.adminDeleteMembershipPackage,
